...
class RequireJsModulesConversionSpec extends Specification {
    ...
    void 'convert require modules if sourceFile not exists'() {
        ...
        when:
        def result = require.convert(invalidFile, destinationFolder)
    ...
    void 'convert require modules without dependencies'() {
        when:
        def result = require.convert(validFile, destinationFolder)
    ...
    private RequireJsModulesConversion require = new RequireJsModulesConversion(
