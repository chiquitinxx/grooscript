...
image:https://semaphoreci.com/api/v1/{project-full-path}/branches/{github-branch}/badge.svg["Build Status", link="https://semaphoreci.com/{project-full-path}"]
...
Converts your Groovy or Java code to JavaScript(Groovy 3.x to Javascript ECMAScript 6). You need groovy jar greater than 3.0 to make conversions. For more information about the project, see http://grooscript.org[grooscript.org]
...
Converted code, needs link:https://github.com/{project-full-path}/blob/master/dist/grooscript.js[grooscript.js] to run. grooscript.js inside the jar in META-INF/resources for servlet 3.0 support. Also a Node.js link:http://www.npmjs.org/package/grooscript[npm] module imports it.
