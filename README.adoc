...
The latest release version is *{current-version}*, released on 2015-05-21. The current development version is *{next-version}*.
...
Using gradle wrapper, version 2.4. Only GPars 1.2.1 and Groovy dependencies in the project. You need JDK 1.7+ to build and test the project.
